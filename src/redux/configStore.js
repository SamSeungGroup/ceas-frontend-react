...
import { UserNameReducer } from "./reducers/UserNameReducer"; // UserIdReducer 컴포넌트: 'userId(회원 아이디)'를 반환하는 'reducer'
...
const allReducers = combineReducers({
  ...
  UserName: UserNameReducer,  // UserName 필드: 'redux-persist'와 결합하기 위한 'UserNameReducer' 저장
}); 
