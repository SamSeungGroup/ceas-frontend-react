...
const SignUp = () => {
    ...
    const validationSchema = Yup.object().shape({                                               // validationSchema 변수: '입력된 값의 유효성 검증' 기능 저장
        ...
        userPassword: Yup.string()
            ...
            .required("패스워드를 입력하세요."),                                                // required 메소드: '필수 입력 안내 메시지' 표시
        ...
        userPassword2: Yup.string()
            ...
            .required("필수 입력 값입니다."),                                                   // required 메소드: '필수 입력 안내 메세지' 표시
  ...
  const submit = async (values) => {                                                       // value 매개변수: '이용자'가 입력한 '닉네임/이메일/아이디/비밀번호' 데이터를 받아옴
    // (1) 변수 설정
