...
//   - 설명: '회원'이 '회원 이미지 업로드' 기능 

/* 1. 모듈 추가 */
// 1-1. 'SCSS' 모듈 추가 
import "./myinformationimageuploader.scss";  // imageUploader.scss 모듈: '이미지 업로드' 기능 스타일
...
/* 2. 함수 설정 */
// MuInformationImageUploader 함수: '회원 이미지'를 업로드할 수 있는 기능 구현 + 화면 표시
const MyInformationImageUploader = ({ preview_URL, setUserImage }) => {                                                                 
    // [1] 변수 설정
  ...
  // [3] 처리
  return (
    <div className = "myinformation-uploader_wrapper">
        <input 
            type = "file" 
            accept = "image/*" 
            onChange = { saveImage } 
        ...
        <div className = "myinformation-img_wrapper">
            <img src = { preview_URL } />
        </div>
        
        <div className = "myinformation-upload_button">
            <Button 
                variant = "outlined" 
                color = "primary" 
...
/* 3. 처리 */
// MyInformationImageUploader 함수 내보내기
export default MyInformationImageUploader;